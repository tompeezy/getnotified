        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          <div className="rounded-2xl border border-cyan-500/20 bg-slate-900/85 p-6 shadow-[0_0_40px_rgba(34,211,238,0.08)]">
            ...
            <ul className="mt-6 grid gap-x-8 gap-y-3 text-base text-slate-100 md:grid-cols-2">
              <li>â€¢ Instant phone notifications</li>
              <li>â€¢ Automatic water shutoff</li>
              <li>â€¢ Water leak notifications</li>
              <li>â€¢ Door & window notifications</li>
              <li>â€¢ Smoke notifications</li>
              <li>â€¢ Temperature notifications</li>
              <li>â€¢ No surveillance cameras</li>
              <li>â€¢ No monthly monitoring fees</li>
            </ul>
          </div>
