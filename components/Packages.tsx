...
const network = [
  {name:"Privacy Hub",price:"$179",badge:"Most Popular",desc:"Block ads on every screen",features:["Whole-home ad blocking (every device)","Private DNS — ISP can't track you","Malware & scam site blocking","Device monitoring dashboard","No subscription — ever","Ships pre-configured, plug & play"]},
  {name:"Family Hub",price:"$199",badge:"Best for Families",desc:"Ad blocking + parental controls",features:["Everything in Privacy Hub","Adult site blocking network-wide","Bedtime internet schedules","Per-device internet pause","Social media filtering","Works on Smart TVs & gaming consoles"]},
  {name:"Secure Hub",price:"$229",badge:"Remote Workers",desc:"Ad blocking + encrypted home VPN",features:["Everything in Privacy Hub","Built-in WireGuard VPN","Encrypted access from anywhere","Works securely on public WiFi","No VPN subscription needed","Connect unlimited devices"]},
  {name:"Road Guardian",price:"$249",badge:"🚐 RV & Campers",desc:"Secure private network on the road",features:["Protects ALL devices from campground WiFi","Ad blocking everywhere in the rig","Built-in VPN — fully encrypted tunnel","Runs off USB — draws less than a phone charger","Check your rig remotely from anywhere","No cell data needed — works on any hotspot"]},
]
...
const family = [
  {name:"Family Starter",price:"$499",badge:"New Parents",desc:"Home safety for growing families",features:["Hub computer + setup","2 door/window sensors","1 motion sensor","1 water leak sensor","Phone alerts — whole family","100% private, no cloud"]},
  ...
  return (
    <section id="packages" className="py-20 px-6 bg-slate-50">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-center text-slate-500 mb-4">One-time. No monthly fees. Yours forever.</p>
        <p className="text-center text-[#f59e0b] font-bold mb-16">📦 Ships nationwide — plug in and you&apos;re protected</p>

        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <span className="text-3xl">🔒</span>
            <div>
              <h3 className="text-2xl font-extrabold text-[#1a2744]">GuardianHub — Network Protection</h3>
              <p className="text-slate-500 text-sm">Block ads on every device. No subscriptions. Ships nationwide.</p>
            </div>
          </div>
          ...
          <div className="mt-6 bg-slate-800 border border-slate-600 rounded-xl p-4 text-sm text-slate-300 text-center font-semibold">
            🚫 Blocks Smart TV ads · 🕵️ Stops tracking · ⚡ Faster internet · 🏠 Your data stays home
          </div>
        </div>
        ...
        <p className="text-center text-slate-400 text-sm mt-8">
          Facility & memory care contracts available · Veteran discounts — ask when requesting quote · Custom quotes for unique properties
        </p>
      </div>
    </section>
  )
